...
for t in nm:
    #Read original expression table
    try:
    ...
    for n in df.columns:
        a = n.split('-')
        if int(a[3][0:2]) != 1 and int(a[3][0:2]) != 3: #Select primary cancer based on the tcga barcode (1 and 3 means primary cancer)
